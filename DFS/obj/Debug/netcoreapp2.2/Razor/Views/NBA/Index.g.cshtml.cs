#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "35c0a28f32840edda044a7507dec63105f495c74"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"35c0a28f32840edda044a7507dec63105f495c74", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "35c0a28f32840edda044a7507dec63105f495c744567", async() => {
            }
            );
    ...
    $(function () {
        ...
        gamesList.on(""click"", '.TeamName', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    tabulate(jsonData);
                    fillChar");
            WriteLiteral(@"tDetails(jsonData)
                },
                error: function () {
        ...
        var fillChartDetails = function (data) {
            ...
            $.each(data, function (i, value) {
               ...
               ");
            WriteLiteral(@"             tableColumns[t] = value.Position + ""_"" + String(id) + ""_"" + v;
                        });

                        court.find(""#"" + tableColumns[0]) = value.MinutesPlayed;
                        court.find(""#"" + tableColumns[1]) = value.DefensiveRating;
                        court.find(""#"" + tableColumns[2]) = value.OffensiveRating;
                        court.find(""#"" + tableColumns[3]) = value.Usage;
                        court.find(""#"" + tableColumns[4]) = value.Points;
                    }
