#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d43d309733622e9b0365b3df0a03aebda64771cf"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d43d309733622e9b0365b3df0a03aebda64771cf", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d43d309733622e9b0365b3df0a03aebda64771cf4567", async() => {
            }
            );
...
<script>
    $(function () {
       ...
       ");
            WriteLiteral(@" function PopulateGames(data) {
        ...
        var tabu");
            WriteLiteral(@"late = function (data) {
            console.log(data);
            ...
            var Columnmodel = [
                ...
                { name: 'FieldGoalAttempted', index: 'Fiel");
            WriteLiteral(@"dGoalAttempted', width: 20, align: 'center', editable: false },
                ...
                { name: 'TotalRebound', index");
            WriteLiteral(@": 'TotalRebound', width: 50, align: 'center', editable: false },
            ...
            $(""#jqGrid"").jqGrid({
                ...
                datastr: data,
                jsonReade");
            WriteLiteral("r: { repeatitems: false },\r\n                rowNum: 25,\r\n                subGrid: false,\r\n                viewrecords: true,\r\n                height: \"auto\",\r\n                ignoreCase: true\r\n            });\r\n        };\r\n\r\n\r\n    });\r\n</script>\r\n");
            EndContext();
        }
