#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fe42c61067e5c8a2dcfc103bc0acad0433b141b5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fe42c61067e5c8a2dcfc103bc0acad0433b141b5", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "fe42c61067e5c8a2dcfc103bc0acad0433b141b54520", async() => {
            }
            );
...
<script>
    var gridPlayerCoulmns = [
                ...
                { name: 'ShotType', index: 'Sho");
            WriteLiteral(@"tType', width: 100, align: 'right', editable: false },
    ...
    var gridTeamColumn = [
                ...
                { name: 'MadeShots', index: 'MadeShots', width: 100, align: 'right', editable: false },
                { name: 'TotalShots', index: 'TotalShots', width: 100, align: 'right', editable: ");
            WriteLiteral(@"false },
                { name: 'ZonePer', index: 'ZonePer', width: 100, align: 'right', editable: false, sortable: true }
            ];
    ...
    var playerStatColumn = [
                ...
                { name: 'salary',");
            WriteLiteral(@" index: 'salary', width: 70, align: 'right', editable: false, sortable: true, search: false },
                { name: 'salaryDifference', index: 'salaryDifference', width: 70, align: 'right', editable: false, sortable: true, search: false },
                ...
                { name: 'minutesPlayed', index: 'MinutesPlayed', width: 100, align: 'right', editable: false, sortable: true, search: false },
                ...
                { name: 'height', index: 'Height', width: 80, align: 'right', editabl");
            WriteLiteral(@"e: false, sortable: true, search: false },
                ...
                { name: 'fieldGoalAttempted', index: 'FieldGoalAttempted', width: 50, align: 'right', editable: false, sortable: true, search: false },
                { name: 'threePointer', index: 'ThreePointer', width: 50, align: 'right', editable: false, sortable: true, search: false },
                { name: 'threePointerAttempted', index: 'ThreePointerAttempted', width: 50, align: 'right', editable: false, sortable: true, search: false },
               ...
               ");
            WriteLiteral(@" { name: 'totalRebound', index: 'TotalRebound', width: 50, align: 'right', editable: false, sortable: true, search: false },
                ...
                { name: 'points', index: 'Points', width: 50, align: 'right', editable: false, sortable: true, search: fal");
            WriteLiteral(@"se }
            ];
    ...
    $(function () {
        ...
        function PopulateGames(data) {
            ga");
            WriteLiteral(@"mesList.find('.card').remove();
        ...
        gamesList.on(""click"", '.TeamName', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    GetTeamZoneD");
            WriteLiteral(@"ata(data.activePlayerList, params.team, params.opp);
                },
                error: function () {
  ...
  ");
            WriteLiteral(@"              else {
                ...
                if (String(nbaPositions[value.position]) === ""undefined"") {
                    ...
                    cour");
            WriteLiteral(@"t.find(""#"" + tableColumns[3]).text(value.usage);
