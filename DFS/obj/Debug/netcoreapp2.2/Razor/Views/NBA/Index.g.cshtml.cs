#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "52b47a03ea6fe5991b9d5a727f5d5be170893b0d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"52b47a03ea6fe5991b9d5a727f5d5be170893b0d", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "52b47a03ea6fe5991b9d5a727f5d5be170893b0d4569", async() => {
            }
            );
...
<script>
   ...
   ");
        ...
        var tabulate = function () {
            var gridColNames = [""Name"", ""Team"", ""Pos"", ""Usage"", ""Mins"", ""Def.R"", ""Off.R"", ""Height"", ""FG");
            WriteLiteral(@""", ""FGA"",
                ""3P"", ""3PA"", ""FT"",
                //""ORB"", ""DRB"",
                ""TRB"", ""AST"", ""STL"", ""BLK"",
            ...
            var Columnmodel = [
                ...
                { name: '");
            WriteLiteral(@"offensiveRating', index: 'OffensiveRating', width: 50, align: 'center', editable: false, sortable: true, search:false },
                ...
                //{ name: 'offensiveRebound', inde");
            WriteLiteral(@"x: 'OffensiveRebound', width: 50, align: 'center', editable: false },
                ...
                //{ name: 'fou");
            WriteLiteral(@"ls', index: 'Fouls', width: 50, align: 'center', editable: false, sortable: true },
  ...
  ");
        ...
        ");
            WriteLiteral(@"var clearChartDetials = function () {
            var tableColumns = [""Min"", ""Def"", ""Off"", ""Usa"", ""Eff""];
    ...
    $(document).ajaxStop(function () {
        ...
        p");
            WriteLiteral(@"layerName.on(""click"", function (e) {
            var params = {};
            params[""name""] = $(e.target).text().split(""("")[0];
        ...
        var tabulateShotZones = function (shotData) {
            ...
            var Columnmodel = [
                { name: 'ShotType', index: 'ShotType', width: 150, align: 'center', editable: false },
                { name: 'MadeShots', index: 'MadeShots");
