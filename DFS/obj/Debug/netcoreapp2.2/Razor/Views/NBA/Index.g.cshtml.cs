#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6abf6f0b79882cfb0eb2af918312d64e1c780fc6"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6abf6f0b79882cfb0eb2af918312d64e1c780fc6", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6abf6f0b79882cfb0eb2af918312d64e1c780fc64538", async() => {
            }
            );
    ...
    $(function () {
        ...
        function PopulateGames(data) {
            ...
            $.each(data, function (i, value) {
                gamesList.append($(""<div class='card'><button class='TeamName'>"" + value.Home");
            WriteLiteral(@"Team + ""</button><button class='TeamName'>"" + value.AwayTeam + ""</button>""));
            });
        };
        ...
        var GetTeamZoneData = function ");
            WriteLiteral(@"(playerList, team, opp) {
            var params = {};
            params.nameList = [];
            params.team = team;
            params.opp = opp;
        ...
        var mainGrid = function () {
            var gridColNames = [""Name"", ""Team"", ""Pos"", ""Predicted"", ""Salary"", ""Diff"", ""Act");
            WriteLiteral(@"ual"", ""Usage"", ""Mins"", ""Def.R"", ""Off.R"", ""Height"", ""FG"", ""FGA"",
                ""3P"", ""3PA"", ""FT"",
                //""ORB"", ""DRB"",
                ""TRB"", ""AST"", ""STL"", ""BLK"",
                //""TOV"", ""PF"",
            ...
            WriteLiteral(@"false },
                ...
                { name: 'fieldGoalAttempted', index: 'Fie");
            WriteLiteral(@"ldGoalAttempted', width: 50, align: 'center', editable: false, sortable: true, search: false },
                ...
                //{ name: 'totalReboundPercentage', index: 'TotalReboundPercentage', width: 50, align: 'center',");
        ...
        playerName.on(""click"", function (e) {
            var params = {};
  ");
            WriteLiteral(@"          params[""name""] = $(e.target).text().split(""("")[0];
        ...
        FillInactivePlayers = function (data, team) {
            team1Inactiv");
            WriteLiteral(@"e.find(""label"").remove();
        ...
        var tabulateTeamShotZones = function (shotData) {
            ...
            var Columnmodel = [
                ...
                { name: 'ShotType', index: 'ShotType', width: 150, align: 'left', editable: false },
                { n");
            WriteLiteral(@"ame: 'MadeShots', index: 'MadeShots', width: 100, align: 'right', editable: false },
                { name: 'TotalShots', index: 'TotalShots', width: 100, align: 'right', editable: false },
                { name: 'ZonePer', index: 'ZonePer', width: 100, align: 'right', editable: false, sortable: true }
            ];
        ...
        var clearChartDetials = function () {
            ...
            $.each(tableColumns, function (i, tblV) {
                $.each(positions, function (i, data) {
                    // Player table Reset
       ");
            WriteLiteral(@"             idList = idList.concat(""[id^="" + data + ""_1_"" + tblV + ""]"");
    ...
    $(document).ajaxStop(function () {
        ...
        var tabulateShotZones = function (shotData) {
            ...
            var Columnmodel = [
                ...
                { name: 'MadeShots', index: 'MadeShots', width: 100, align: 'right', editable: false },
                { name: 'TotalShots', index: 'TotalShots', width: 100, align: 'right', editable: false },
                { name: 'ZonePer', index: 'ZonePer', width: 100, align: ");
            WriteLiteral(@"'right', editable: false, sortable: true }
            ];
