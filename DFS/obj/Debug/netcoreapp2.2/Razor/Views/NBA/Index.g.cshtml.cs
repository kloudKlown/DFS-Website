#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6a68bd21291ceba453f7c82492ad5a99e633196d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6a68bd21291ceba453f7c82492ad5a99e633196d", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "6a68bd21291ceba453f7c82492ad5a99e633196d4569", async() => {
            }
            );
        ...
        gamesList.on(""click"", '.TeamName', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    GetTeamZoneData(data.activePlayerList, params.team);
                },
                error: function () {
...
");
        ...
        var GetTeamZoneData = function (playerList, team) {
            var params = {};
            params.nameList = [];
            params.team = team;
        ...
        var tabulate = fu");
            ...
            var Columnmodel = [
                ...
                { name");
            WriteLiteral(@": 'salaryDifference', index: 'salaryDifference', width: 70, align: 'center', editable: false, sortable: true, search: false },
                ...
                { name: 'fieldGoal', index: 'FieldGoal', width: 50,");
            WriteLiteral(@" align: 'center', editable: false, sortable: true, search: false },
                ...
                { name: 'totalRebound', index: 'TotalRebound', width: 50, align: 'center', editable: false, sortable: tru");
            WriteLiteral(@"e, search: false },
            ...
            $(");
            WriteLiteral(@"""#jqGrid"").jqGrid('filterToolbar', { stringResult: true, defaultSearch: 'cn' });
...
");
            WriteLiteral(@"                    nbaPositions = {};
                ...
                if (String(nbaPositions[value.position]) === ""undefined"") {
                    ...
                    court.find(""#"" + tableColu");
            WriteLiteral(@"mns[3]).text(value.usage);
        ...
        var clearChartDetials = function () {
            var tableColumns = [""Mi");
            WriteLiteral(@"n"", ""Def"", ""Off"", ""Usa"", ""Eff""];
    ...
    $(document).ajaxStop(function () {
       ...
       ");
            WriteLiteral(@" playerName.on(""click"", function (e) {
            var params = {};
            params[""name""] = $(e.target).text().split(""("")[0];
            ...
            $.ajax({
                ...
                data: params,
                success: function (data) {
                    tabulateShotZones(JSON.parse(data.shotZone), params[""name""]);
                },
                error: function () {
        ...
        var tabulateShotZones = function (shotData, name) {
            var gridColNames = [""Player"", ""Shot Type"", ""Shots Made"", ""Shots Taken"", ""Percentage""]
            ...
            var Columnmodel = [
                { name: 'Player', index: 'Player', width: 100, align: 'center', editable: false },
                { name: ");
            WriteLiteral(@"'ShotType', index: 'ShotType', width: 150, align: 'left', editable: false },
                { name: 'MadeShots', index: 'MadeShots', width: 100, align: 'right', editable: false },
                { name: 'TotalShots', index: 'TotalShots', width: 100, align: 'right', editable: false },
                { name: 'ZonePer', index: 'ZonePer', width: 100, align: 'right', editable: false, sortable: true }
            ];
