#pragma checksum "D:\DFS Website\DFS\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fffa7389b30d57adf6001755c98914bb5a540638"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fffa7389b30d57adf6001755c98914bb5a540638", @"/Views/NBA/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "fffa7389b30d57adf6001755c98914bb5a5406384567", async() => {
            }
            );
            ...
            $.each(data, function (i, value) {
                ...
                if (value.Team === primaryTeam) {
                    if (String(nbaPositions[value.Position]) === ""undefined"") {                        
                        ...
                        // Set Player Name
                        court.find(""#"" + value.Position + ""_"" + String(id) + ""_L"").text(val");
            WriteLiteral(@"ue.Name + ""("" + String(value.Height) + "")"" );
