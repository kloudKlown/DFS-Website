#pragma checksum "C:\Users\suhas\Source\Repos\kloudKlown\DFS-Website\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "59fb16e834a2a3e0a25b9bc2e1c161426ad00fe8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"59fb16e834a2a3e0a25b9bc2e1c161426ad00fe8", @"/Views/NBA/Index.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "59fb16e834a2a3e0a25b9bc2e1c161426ad00fe84582", async() => {
            }
            );
...
<script>
    ...
    var playerStatColumn = [
        ...
        { name: 'salary', index: 'salary', width: 70, align: 'right', editable: false, sortable: true, search: false },
        {
         ...
         ");
            WriteLiteral(@"   editable: false, sortable: true, search: false, formatter: function (cellvalue, options, rowObject) {                
                if (cellvalue < 0) {
        ...
        {
            name: 'minutesPlayed'");
            WriteLiteral(@", index: 'MinutesPlayed', width: 60, align: 'right', editable: false, sortable: true, search: false,
        ...
        { name: 'threePointer', index: 'ThreePointer");
            WriteLiteral(@"', width: 50, align: 'right', editable: false, sortable: true, search: false },
   ...
   ");
    ...
    $(function () {
        ...
        var mainGrid = function () {
            ...
            $(""#jqGrid"").jqGrid('filterToolbar', { stringResult: true, defaultSea");
            WriteLiteral(@"rch: 'cn' });
        ...
        var FillChartDetails = function (data) {
            ...
            WriteLiteral(@"
                ...
                if (String(nbaPositions[value.position]) === ""undefined"") {
                    ...
                    court.find(""#"" + ta");
            WriteLiteral(@"bleColumns[4]).text(value.points);
                }
