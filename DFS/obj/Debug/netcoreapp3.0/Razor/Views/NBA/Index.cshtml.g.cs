#pragma checksum "C:\Users\suhas\source\repos\kloudKlown\DFS-Website\DFS\Views\NBA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "425ac13e7679573bae54182f846736ee17e9a9d7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"425ac13e7679573bae54182f846736ee17e9a9d7", @"/Views/NBA/Index.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "425ac13e7679573bae54182f846736ee17e9a9d74582", async() => {
            }
            );
...
<script>
    ...
    var playerStatColumn = [
        { name: 'name', index: 'Name', width: 180, align: 'left', editable: false,");
            WriteLiteral(@" classes: ""playerName"" },
        ...
        { name: 'salary', index: 'salary', width: 70, align: 'right', editable: false, sortable: true, search: false },
        {
            ...
            editable: false, sortable: true, search: false, formatter: function (cellvalue, options, rowObject) {
                if (cellvalue < 0) {
                    ...
                    ");
            WriteLiteral(@"var brightnessPer = cellvalue * 10 / rowObject.salary.replace(""$"", """");
        ...
        { name: 'offensiveRating', index: 'OffensiveRati");
            WriteLiteral(@"ng', width: 80, align: 'right', editable: false, sortable: true, search: false },
        ...
        //{ name: 'offensiveRebound', index: 'OffensiveRebound', width: 50, align: 'center', edit");
        ...
        { name");
            WriteLiteral(@": 'points', index: 'Points', width: 50, align: 'right', editable: false, sortable: true, search: false, summaryType: 'sum' }
    ];
 ...
 ");
            WriteLiteral(@"                   FillInactivePlayers(data.inactivePlayersList, params.team);
      ...
      ");
            WriteLiteral(@"          colModel: playerStatColumn,
                pager: '#shotPager',
                datatype: ""json"",
                gridview: true,
                loadonce: false,
        ...
        var FillChartDetails = function (data) {
            ...
            $.each(data, function (i, value) {
                ...
                if (String(nba");
            WriteLiteral(@"Positions[value.position]) === ""undefined"") {
        ...
        Fi");
            WriteLiteral(@"llInactivePlayers = function (data, team) {
        ...
        var tabulateTeamShotZones = function (shotData) {
            ...
            $(""#playerTeamZone"").j");
            WriteLiteral(@"qGrid('setGridParam',
                {
                    data: shotData
                })
                .trigger(""reloadGrid"");
...
");
            WriteLiteral(@"            $.each(tableColumns, function (i, tblV) {
