#pragma checksum "C:\Users\suhas\source\repos\kloudKlown\DFS-Website\DFS\Views\NCAA\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b0d6cf63d9cab9ad224b7cc29d82b4169c340ae7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b0d6cf63d9cab9ad224b7cc29d82b4169c340ae7", @"/Views/NCAA/Index.cshtml")]
...
<script>
    ...
    $(function () {
        ...
        ");
            WriteLiteral(@"            ""<br/>Pre: <b>"" + value.Predicted + "" - "" + value.PredictedOpp + ""</b>"" +
                    ""<br/>Avg: <b>"" + value.TotalTeamScore + "" - "" + value.OpposingTeamScore + ""</b>"" +
                    ""<br/>All: <b>"" + value.TeamAllowed + "" - "" + value.OppAllowed + ""</b>"" +
                    ""<br/>Act: <b>"" + value.Actual + "" - "" + value.ActualOpp + ""</b>"" +
        ...
        var mainGrid = function () {
            $(""#jqGrid"").jqGrid({
                ...
                url: ""/NCAA/GetGridData"",
    ");
            WriteLiteral(@"            colNames: playerStatColumnNames,
                colModel: playerStatColumn,
                pager: '#shotPager',
                datatype: ""json"",
                gridview: true,
        ...
        date.");
            WriteLiteral("val(new Date().toLocaleDateString());\r\n        date.trigger(\"change\");\r\n    });\r\n</script>");
        }
